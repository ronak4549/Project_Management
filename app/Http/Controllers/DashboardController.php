...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        return inertia("Dashboard", compact("activeTasks", "totalPendingTasks", "myPendingTasks", "totalInProgressTasks", "myInProgressTasks", "totalCompletedTasks", "myCompletedTasks"));
    }
}
